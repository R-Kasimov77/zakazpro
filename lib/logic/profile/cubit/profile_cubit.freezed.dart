...
class _$ProfileStateTearOff {
  ...
  _Loaded loaded(Profile response) {
    return _Loaded(
      response,
    );
  }
...
mixin _$ProfileState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Profile response) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(Profile response)? loaded,
...
abstract class _Loaded implements ProfileState {
  const factory _Loaded(Profile response) = _$_Loaded;

  Profile get response => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
